...
namespace API_SERVER_CEA.Controllers
{
    ...
    public class UserRolesController : ControllerBase
    {
        ...
        // GET: api/UserRoles
        [HttpGet]
        public async Task<ActionResult<IEnumerable<UserRole>>> GetUsuarioRol()
        {
        ...
        {
            var userRole = await _context.UsuarioRol.FindAsync(id);
        ...
        {
            _context.UsuarioRol.Add(userRole);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteUserRole(int id)
        {
            ...
            _context.UsuarioRol.Remove(userRole);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.UsuarioRol.Any(e => e.Id == id);
        }
    }
}
